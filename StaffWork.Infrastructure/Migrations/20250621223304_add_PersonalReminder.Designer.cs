...
namespace StaffWork.Infrastructure.Migrations
{
    ...
    [Migration("20250621223304_add_PersonalReminder")]
    partial class add_PersonalReminder
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StaffWork.Core.Models.Notification", b =>
                {
                    ...
                    b.Property<int?>("PersonalReminderId")
                        .HasColumnType("int");

                    b.Property<int?>("TaskReminderId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("StaffWork.Core.Models.PersonalReminder", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<bool>("IsReminderCompleted")
                        .HasColumnType("bit");
                    ...
                    b.Property<DateTime?>("ReminderCompletedDate")
                        .HasColumnType("datetime2");
                    ...
                    b.ToTable("PersonalReminders");
                });

            modelBuilder.Entity("StaffWork.Core.Models.PersonalReminderFile", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("PersonalReminderFiles");
                });
            ...
            modelBuilder.Entity("StaffWork.Core.Models.TaskReminderFile", b =>
                {
                    ...
                    b.ToTable("TaskReminderFile");
                });

            modelBuilder.Entity("StaffWork.Core.Models.TaskUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("StaffWork.Core.Models.Notification", b =>
                {
                    b.HasOne("StaffWork.Core.Models.PersonalReminder", "PersonalReminder")
                        .WithMany("Notifications")
                        .HasForeignKey("PersonalReminderId");

                    b.HasOne("StaffWork.Core.Models.TaskReminder", "TaskReminder")
                        .WithMany("Notifications")
                        .HasForeignKey("TaskReminderId");

                    b.Navigation("PersonalReminder");
            ...
            modelBuilder.Entity("StaffWork.Core.Models.PersonalReminder", b =>
                {
                    b.HasOne("StaffWork.Core.Models.User", "CreatedByUser")
                        .WithMany()
            ...
            modelBuilder.Entity("StaffWork.Core.Models.PersonalReminderFile", b =>
                {
                    b.HasOne("StaffWork.Core.Models.PersonalReminder", "PersonalReminder")
                        .WithMany("PersonalReminderFiles")
                        .HasForeignKey("PersonalReminderId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("StaffWork.Core.Models.PersonalReminder", b =>
                {
                    ...
                    b.Navigation("PersonalReminderFiles");
                });
            ...
            modelBuilder.Entity("StaffWork.Core.Models.TaskReminder", b =>
                {
                    ...
                    b.Navigation("TaskReminderFiles");
                });
