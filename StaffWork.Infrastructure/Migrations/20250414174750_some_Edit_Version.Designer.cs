...
namespace StaffWork.Infrastructure.Migrations
{
    ...
    [Migration("20250414174750_some_Edit_Version")]
    partial class some_Edit_Version
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StaffWork.Core.Models.Administration", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("StaffWork.Core.Models.Administration", b =>
                {
                    b.HasOne("StaffWork.Core.Models.User", "Manager")
                        .WithOne("Administration")
                        .HasForeignKey("StaffWork.Core.Models.Administration", "ManagerId");
            ...
            modelBuilder.Entity("StaffWork.Core.Models.Department", b =>
                {
                    b.HasOne("StaffWork.Core.Models.Administration", null)
                        .WithMany("Departments")
                        .HasForeignKey("AdministrationId");

                    b.HasOne("StaffWork.Core.Models.DepartmentAdmin", "DepartmentAdmin")
                        .WithOne("Department")
                        .HasForeignKey("StaffWork.Core.Models.Department", "DepartmentAdminId");
            ...
            modelBuilder.Entity("StaffWork.Core.Models.DepartmentAdmin", b =>
                {
                    b.HasOne("StaffWork.Core.Models.User", "Admin")
                        .WithMany()
            ...
            modelBuilder.Entity("StaffWork.Core.Models.Employee", b =>
                {
                    b.HasOne("StaffWork.Core.Models.Administration", "Administration")
                        .WithMany()
                        .HasForeignKey("AdministrationId");
            ...
            modelBuilder.Entity("StaffWork.Core.Models.User", b =>
                {
                    b.HasOne("StaffWork.Core.Models.DepartmentAdmin", "DepartmentAdmin")
                        .WithMany()
                        .HasForeignKey("DepartmentAdminId");
